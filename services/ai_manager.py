...
async def get_ai_response(history):
    ...
    system_prompt = {
        ...
        "content": (
            ...
            "Отслеживай его прогресс, предлагай следующие шаги, связывай новые концепции с уже изученными.\n"
            "Если видишь в истории диалога факты о пользователе (от system), используй их для персонализации.\n"
