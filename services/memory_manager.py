    ...
    if not receiving:
        ...
        prompt = {
            ...
            "content": (
                ...
                "Есть ли среди существующих факт с ТЕМ ЖЕ СМЫСЛОМ, что и новый "
                "(даже если сформулирован другими словами), ИЛИ прямое противоречие? "
                "Если да — ответь только цифрой id этого факта. Если нет — ответь словом None."
            )
        }
        full_task_1 = [prompt]
