...
async def run_agent(user_id: int, message: str) -> str:
    ...
    system_prompt = (
        "Ты — автономный ИИ-ассистент Орион, функционирующий в стиле Джарвиса из 'Железного человека'. "
        "Ты работаешь строго по архитектурному ReAct-циклу (Мысль -> Действие -> Результат -> Мысль).\n\n"
